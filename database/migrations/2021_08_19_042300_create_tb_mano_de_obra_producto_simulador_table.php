...
class CreateTbManoDeObraProductoSimuladorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_mano_de_obra_producto_simulador', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tb_mano_de_obra_producto_simulador');
    }
}
