                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="detallefacturas in arrayDetallefacturas" :key="detallefacturas.id">
                                        ...
                                        <td v-text="detallefacturas.documento"></td>
                                        <td v-text="detallefacturas.detallefacturas"></td>
                                        <td v-text="detallefacturas.email"></td>
                                        <td v-text="detallefacturas.rol"></td>
                                        <td>
                            ...
                            <div class="modal-body">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" v-model="detallefacturas" class="form-control" placeholder="Nombre de detallefacturas">
                                            <span class="help-block">(*) Ingrese el nombre del detallefacturas</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row div-error" v-show="errorDetallefacturas">
