                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="roles in arrayRoles" :key="roles.id">
                                        ...
                                        <td v-text="roles.documento"></td>
                                        <td v-text="roles.roles"></td>
                                        <td v-text="roles.email"></td>
                            ...
                            <div class="modal-body">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" v-model="roles" class="form-control" placeholder="Nombre de roles">
                                            <span class="help-block">(*) Ingrese el nombre del roles</span>
                                        </div>
                                    </div>
