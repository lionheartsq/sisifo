                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i> Impuesto &nbsp;
                            <button type="button" @click="abrirModal('impuesto','crear')" class="btn btn-secondary">
...
<script>
    export default {
        ...
        methods : {
            listarImpuesto(page,buscar,criterio){
                let me=this;
                var url='/impuesto?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
                // Make a request for a user with a given ID
                axios.get(url).then(function (response) {
                    // handle success
                var respuesta=response.data;
                me.arrayImpuesto=respuesta.impuesto.data;
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.listarImpuesto(page,buscar,criterio);
            },
            crearImpuesto(){
                //valido con el metodo de validacion creado
                if(this.validarImpuesto()){
                    return;
                }
        ...
        mounted() {
            this.listarImpuesto(1,this.buscar,this.criterio);
        }
    }
</script>
<style>
