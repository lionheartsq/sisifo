                            ...
                            <div class="modal-body">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" v-model="tipo" class="form-control" placeholder="Nombre de tipo">
                                    ...
                                    <div class="form-group row div-error" v-show="errorTipo">
    ...
    export default {
        ...
        methods : {
            ...
            validarTipo(){
                ...
                if (!this.Tipo) this.errorMensaje.push("El nombre del tipo no puede estar vacio");
