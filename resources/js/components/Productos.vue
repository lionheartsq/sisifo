                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="tipo">
                                            ...
                                            <!-- <option v-for="tipo in arrayArea" :key="area.tipo" :value="area.tipo" v-text="area.area"></option> -->
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="valorCompra" class="form-control" placeholder="Valor Compra de producto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" v-if="tipo==2">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" v-model="capacidadMensual" class="form-control" placeholder="Capacidad de producción">
